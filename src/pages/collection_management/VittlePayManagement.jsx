...
import tempImage from "../../assets/images/paygate/vietnamViettelPay.png";
...
export default () => {
  ...
  async function myFunc() {
    ...
    await dispatch(getCollectionCards("ViettelPay"));
    dispatch(setSuccess(false));
  }

  async function myFunc1() {
    if (classification !== "all")
      await dispatch(changeCardClassification("ViettelPay", classification));
  ...
  const onClickAddNewPayment = () => {
    dispatch(addCollectionCard(newPayment, "ViettelPay"));
  };

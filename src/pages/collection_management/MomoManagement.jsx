...
import tempImage from "../../assets/images/paygate/vietnamMOMO.png";
...
export default () => {
  ...
  async function myFunc() {
    ...
    await dispatch(getCollectionCards("Momo"));
    dispatch(setSuccess(false));
  }

  async function myFunc1() {
    if (classification !== "all")
      await dispatch(changeCardClassification("Momo", classification));
  ...
  const onClickAddNewPayment = () => {
    dispatch(addCollectionCard(newPayment, "Momo"));
  };
